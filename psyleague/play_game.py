...
if __name__ == '__main__':
    ...
    cmd = 'java -jar ../SummerChallenge2024Olymbits/target/spring-2024-olympics-1.0-SNAPSHOT.jar' + ''.join([f' -p{i} "{sys.argv[i]}"' for i in range(1, n_players+1)]) + f' -d seed={seed} -l "{log_file}"'
